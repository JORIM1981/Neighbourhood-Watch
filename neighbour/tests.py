...
class ProfileTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.new_profile = Profile(bio="I am superman")
    ...
    def test_get_other_profiles(self):
        ...
        '''
        self.jorim = User(username="midumbi")
        self.jorim.save()

        self.jorim = User(username="habibi")
        self.jorim.save()

        self.test_profile = Profile(user=self.jorim, bio="Another Profile")
        gotten_profiles = Profile.get_other_profiles(self.jorim.id)
...
class Post(TestCase):
    ...
    def test_get_Image_comments(self):
        ...
        '''
        self.jorim = User(username="hulk")
        self.jorim.save()

        self.jorim = User(username="thanos")
        self.jorim.save()

        self.test_profile = Profile(user=self.jorim, bio="Another Profile")

        self.test_Image = Image(user=self.jorim, caption="Another Profile")
